...
class TestDurableFunctions(unittest.TestCase):
    def test_object_creation_payload(self):
        ...
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.apiSchemaVersion, "10-01-2021-preview"
        )
        self.assertEqual(
    ...
    def test_object_creation_payload_context(self):
        ...
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.authProtocol.type, "OAUTH2.0"
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.clientServicePrincipal.id,
            "40000000-0000-0000-0000-000000000001",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.clientServicePrincipal.appDisplayName,
            "Test client app",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.clientServicePrincipal.displayName,
            "Test client application",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.clientServicePrincipal.appId,
            "40000000-0000-0000-0000-000000000002",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.clientServicePrincipal.servicePrincipalNames,
            ["40000000-0000-0000-0000-000000000002", "http://example.com/client/app1"],
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.resourceServicePrincipal.id,
            "40000000-0000-0000-0000-000000000003",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.resourceServicePrincipal.appId,
            "40000000-0000-0000-0000-000000000004",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.resourceServicePrincipal.appDisplayName,
            "Test resourceapp",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.resourceServicePrincipal.displayName,
            "Test resourceapplication",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.resourceServicePrincipal.servicePrincipalNames,
            ["40000000-0000-0000-0000-000000000004", "https://example.com/resource2"],
        )
    ...
    def test_object_creation_payload_context_user(self):
        ...
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.companyName, "Evo Sts Test"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.creationType, "Invitation"
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.department,
            "Dummy department",
        ...
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.givenName, "Example"
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.mail, "test@example.com"
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.onPremisesSamAccountName,
            "testadmin",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.onPremisesSecurityIdentifier,
            "DummySID",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.onPremiseUserPrincipalName,
            "Dummy Name",
        )
        self.assertEqual(
            onTokenIssuanceStartRequest.payload.context.user.preferredDataLocation,
            "DummyDataLocation",
        )
        self.assertEqual(
