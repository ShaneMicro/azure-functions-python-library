...
class TokenIssuanceStartResponse(
    _IActionableResponse[ITokenIssuanceAction], _Serializable
):
    def __init__(
        self,
...
class TokenIssuanceStartData(_IEventData):
    def __init__(
        ...
        authenticationContext: Context = None,
    ):
    ...
    def create_instance(payload: dict = None):
        if payload is not None:
            return TokenIssuanceStartData(
                ...
                authenticationContext=Context.populate(
...
class TokenIssuanceStartRequest(
    _ICloudEventRequest[TokenIssuanceStartResponse, TokenIssuanceStartData]
):
    def __init__(
        self,
